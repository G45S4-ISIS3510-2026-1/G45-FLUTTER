...
class CatalogPageTutor extends StatefulWidget {
  const CatalogPageTutor({super.key});

  @override
  State<CatalogPageTutor> createState() => _CatalogPageState();
}

class _CatalogPageState extends State<CatalogPageTutor> {
